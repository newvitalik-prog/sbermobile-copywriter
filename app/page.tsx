...
const DEFAULT_SYSTEM_MESSAGE = `Ты — редактор СберМобайла. Твоя задача: взять черновик смс и привести его к стандартам бренда по правилам ниже. Возвращай только готовый текст смс — без пояснений, комментариев и вариантов.
